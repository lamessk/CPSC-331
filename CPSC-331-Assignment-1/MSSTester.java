...
Assignment 1- JUnit Tests for maxSubSum1 method. 
...
public class MSSTester {
	...
	//Test if input is an array of integers
	@Test (expected = IllegalArgumentException.class)
	...
	public void emptyTest() {
		...
		assertEquals(0, emptyTester.maxSubSum1(A));
	}

	//Test if array is full of all negative integers
	@Test
	public void negativeTest() {
		int[] A = {-8, -3, -10, -4, -5};
		System.out.println("Testing for negative array...");
		MaxSubsequenceSum negativeTester = new MaxSubsequenceSum();
		assertEquals(0, negativeTester.maxSubSum1 (A));
	}
	...
	public void oneElementTest() {
		...
		assertEquals(2, oneElement.maxSubSum1 (A));
	}
	
	//Test if array maxSubSum is the sum of the last two elements
	@Test
	public void lastTwoTest() {
		...
		assertEquals(22, lastTwo.maxSubSum1(A));
	}
	
	//Test if array maxSubSum is sum of first two elements
	@Test
	public void firstTwoTest() {
		...
		assertEquals(52, firstTwo.maxSubSum1 (A));
	}

	//Test if an iteger array was passed as input
	@Test 
	public void integerArrayTest() {
		...
		assertEquals(38, integerTest.maxSubSum1 (A));
	}
